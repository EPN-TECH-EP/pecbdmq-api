...
public class ApelacionResource {
    ...
    @GetMapping("/apelacionesPorMateria/{cod_materia}")
    public List<ApelacionEstudiante> getbyMateria(@PathVariable("cod_materia") Integer codMateria) throws DataException {
        return objServices.getApelacionesEstudiantesMateria(codMateria);
    }
