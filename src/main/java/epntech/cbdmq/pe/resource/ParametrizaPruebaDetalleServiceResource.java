...
public class ParametrizaPruebaDetalleServiceResource {
	...
	@Autowired
	private ParametrizaPruebaDetalleServiceImpl objService;
	@PostMapping("/crear")
	@ResponseStatus(HttpStatus.CREATED)
	public ResponseEntity<?> guardar(@RequestBody ParametrizaPruebaDetalle obj) throws DataException{
		return new ResponseEntity<>(objService.save(obj), HttpStatus.OK);
	}
	
	@GetMapping("/{id}")
	public ResponseEntity<ParametrizaPruebaDetalle> obtenerPorId(@PathVariable("id") int codigo) {
	...
	public ResponseEntity<ParametrizaPruebaDetalle> actualizarDatos(@PathVariable("id") int codigo, @RequestBody ParametrizaPruebaDetalle obj) throws DataException{
		return (ResponseEntity<ParametrizaPruebaDetalle>) objService.getById(codigo).map(datosGuardados -> {
			...
			ParametrizaPruebaDetalle datosActualizados = null;
			try {
