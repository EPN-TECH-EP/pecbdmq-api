...
public class CursoModuloResource {
	...
	public ResponseEntity<?> guardar(@RequestBody CursoModulo cursoModulo) throws DataException{
		
		return new ResponseEntity<>(cursoModuloServiceImpl.save(cursoModulo), HttpStatus.OK);
	}
	
	@PutMapping("/")
	public ResponseEntity<?> actualizar(@RequestBody CursoModulo cursoModulo)
