...
public class FaltaResource {
	...
	@Autowired
	FaltaServiceImpl objService;
	
	
	@PostMapping("/crear")
	@ResponseStatus(HttpStatus.CREATED)
	public ResponseEntity<?> guardar(@RequestBody Falta obj) throws DataException{
	...
	@GetMapping("/{id}")
	public ResponseEntity<Falta> obtenerPorId(@PathVariable("id") int codigo) {
	...
	@PutMapping("/{id}")
	public ResponseEntity<Falta> actualizarDatos(@PathVariable("id") int codigo, @RequestBody Falta obj) throws DataException{
