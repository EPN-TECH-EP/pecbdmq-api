...
public class SubtipoPruebaResource {
	...
	@Autowired
	private SubtipoPruebaServiceImpl objService;

	@PostMapping("/crear")
	@ResponseStatus(HttpStatus.CREATED)
	public ResponseEntity<?> guardar(@RequestBody SubTipoPrueba obj) throws DataException {
		return new ResponseEntity<>(objService.save(obj), HttpStatus.OK);
	}

	@GetMapping("/{id}")
	public ResponseEntity<SubTipoPrueba> obtenerPorId(@PathVariable("id") int codigo) {
