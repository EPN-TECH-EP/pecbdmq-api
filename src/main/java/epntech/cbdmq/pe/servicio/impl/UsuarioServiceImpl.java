...
public class UsuarioServiceImpl implements UsuarioService, UserDetailsService {
    ...
    @Override
    public Usuario actualizarUsuario(String currentUsername, String newFirstName, String newLastName, String newUsername, String newEmail, String role, boolean isNonLocked, boolean isActive, MultipartFile profileImage) throws UsuarioNoEncontradoExcepcion, NombreUsuarioExisteExcepcion, EmailExisteExcepcion, IOException, NoEsArchivoImagenExcepcion {
    ...
    public void resetPassword(String email) throws MessagingException, EmailNoEncontradoExcepcion {
      ...
      //TODO eliminar línea de log
        LOGGER.info("New user password: " + password);
        //emailService.sendNewPasswordEmail(user.getNombres().concat(" ").concat(user.getApellidos()), password, user.getEmail());
    }
