...
@NamedNativeQuery(name = "MateriaDocumentoDto.findByCodMateriaParalelo",
        query = "\tselect\n" +
                ...
                "left join cbdmq.gen_materia_paralelo gmp on\n" +
                "\tgmp.cod_materia_paralelo = gmp.cod_materia_paralelo\n" +
                "where\n" +
                "\tgmp.cod_materia_periodo =:codMateriaParalelo\n" +
                "\tand gmp.cod_paralelo =:idParalelo\n"
        ,
