...
public class EspecializacionEstudiante {
    ...
    public EspecializacionEstudiante(String cedula, String nombre, String apellido, String codigoUnicoEstudiante, String nombreCargo, String nombreRango, String nombreGrado, String nombreTipoInstructor, String instructor, String nombreAula, String nombreTipo, String nombreCatalogo, Date fechaInicioCurso, Date fechaFinCurso, Date fechaInicioCarga, Date fechaFinCarga, String estadoProceso, Date fechaCreaNota, Time horaCreaNota, String usuarioModificacion, Date fechaModNota, Time horaModNota, BigDecimal notaFinal, boolean resultado) {
        this.cedula = cedula;
        this.nombre = nombre;
