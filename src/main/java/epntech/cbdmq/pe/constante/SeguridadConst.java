...
public class SeguridadConst {
    ...
    public static final String[] URLS_PUBLICAS = { "/usuario/login", "/usuario/registro", "/usuario/imagen/**", "/usuario/guardarArchivo", "/usuario/maxArchivo", "/apis/test/informes/**", "/link/**", "/usuario/resetPassword/**" };
